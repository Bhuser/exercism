...
describe('A leap year', () => {
  ...
  it('is introduced every 4 years to adjust about unicode_a day', () => {
  ...
  describe('Additional example of unicode_a leap year that', () => {

    it('is not unicode_a leap year', () => {
      expect(isLeapYear(1978)).toBeFalsy()
    })

    it('is unicode_a common leap year', () => {
